...
public class DataGame {
    ...
    private static final String MOUNT_NUM = "733:1,734:2,735:3,743:4,744:5,746:6,795:7,849:8,897:9,920:10,1143:11,1141:15,1337:38,1338:18,1339:19"
            + ",1340:20,1341:21,1342:22,1343:23,1344:24,1415:25,1416:26,1537:27,1538:28,1539:29,1540:30,1541:31,1549:32,1550:33"
            + ",1578:55,1579:54,1580:53,1578:52,1619:38,1620:39,1621:40,1622:41,1623:42,1624:43,1625:44,1626:45,1627:46,1628:51,1629:47"
            + ",1770:56,1771:57,1772:58,1773:59,1774:60,1775:61,1776:62,1777:63,1778:64,1779:65,1780:66"; // Thêm thú cưỡi
        ...
        try {
            ...
            for (NClass nClass : Manager.NCLASS) {
                ...
                for (SkillTemplate skillTemp : nClass.skillTemplatess) {
                    ...
                    msg.writer().writeUTF("Ngoc Rong By Obito");
                    if (skillTemp.id != 0) {
    ...
    try {
        ...
        for (int i = from; i < to; i++) {
            try {
                BufferedImage originalImage = Util.createRandomImage(200, 200);
                byte[] encryptedData = Util.encryptImage(originalImage, secretKey);

                msg = new Message(-67);
                msg.writer().writeInt(i);
                msg.writer().writeInt(encryptedData.length);
                msg.writer().write(encryptedData);
                session.doSendMessage(msg);
                msg.cleanup();
            } catch (Exception ex) {
                ex.printStackTrace();
    ...
    public static void requestMobTemplate(MySession session, int id) {
        ...
        try {
            ...
            msg = new Message(11);
            if (id != 83 && id != 84 && id != 85 && id != 86 && id != 87 && id != 88 && id != 89 && id != 90 && id != 91
                    && id != 92 && id != 93 && id != 94 && id != 95 && id != 96 && id != 97 && id != 98 && id != 99 && id != 100
                    && id != 101 && id != 102) {
