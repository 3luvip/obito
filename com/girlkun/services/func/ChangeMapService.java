...
public class ChangeMapService {
    ...
    public void changeZone(Player pl, int zoneId) {
        ...
        if (!pl.isAdmin() || !pl.isBoss) {
            ...
            if (MapService.gI().isMapDiaNguc(pl.zone.map.mapId)) {
...
//    }
    public void goToGas(Player player) {
        ChangeMapService.this.changeMapBySpaceShip(player, 149, -1, -1);
...
//        }
    ...
    public void goToCDRD(Player player) {
        //      ChangeMapService.this.changeMapBySpaceShip(player, 135, -1, -1);
    ...
    public void goToTL(Player player) {
        ChangeMapService.this.changeMapBySpaceShip(player, 102, -1, -1);
    }
