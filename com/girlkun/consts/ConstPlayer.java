...
public class ConstPlayer {
    ...
    public static final int[] HEADBROLY = {1556, 1556, 1556, 1556, 1556, 1556, 1556};
    public static final int[] HEADBROLY1 = {1599, 1599, 1599, 1599, 1599, 1599, 1599};
    public static final int[] HEADBROLY2 = {1549, 1549, 1549, 1549, 1549, 1549, 1549};
    public static final int[] HEADTIENHOA = {1853, 195, 196, 199, 197, 200, 198};
   ...
   // AURA BIẾN HÌNH Ở ĐÂY
    ...
    public static final int[][] HEADBIENHINH = { // 5 head TD 
        {1550, 1553, 1549, 1551, 1552},
        {1599, 1600, 1601, 1602, 1603},// 5 haed NM
         {1556, 1557, 1558, 1559, 1560}, // 5 head XD
    };
    // THÂN NGOẠI HÌNH LV 1-5
    public static final short[] BODYBIENHINH = {1554, 1605, 1561}; // TD /NM/ XD
    public static final short[] LEGBIENHINH = {1555, 1606, 1562}; // TD /NM/ XD
    //type pk
