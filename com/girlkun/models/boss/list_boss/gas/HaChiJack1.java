 ...
 */
public class HaChiJack1 extends Boss {
    ...
    public HaChiJack1(Zone zone, int level, int dame, long hp, Player pl) throws Exception {
        super(BossID.HACHIYACK1, new BossData(
                "Hatchiyack", //name
