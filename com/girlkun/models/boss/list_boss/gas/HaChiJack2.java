 ...
 */
public class HaChiJack2 extends Boss {
    ...
    public HaChiJack2(Zone zone, int level, int dame, long hp, Player pl) throws Exception {
        super(BossID.HACHIYACK2, new BossData(
                "Hatchiyack", //name
