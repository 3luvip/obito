...
import com.girlkun.models.boss.list_boss.gas.DrLyChee1;
import com.girlkun.models.boss.list_boss.gas.HaChiJack1;
import com.girlkun.models.boss.list_boss.gas.HaChiJack2;
    ...
    public void openBanDoKhoBau(Player player, int level) {
        if (level >= 1 && level <= 100000) {
            if (player.clan != null && player.clan.khiGas == null) {
                Item item = InventoryServiceNew.gI().findItemBag(player, 1670);
...
//                           
                            new DrLyChee(player.clan.khiGas.getMapById(148), level, (int) 1, (int) 2,player);
                            new DrLyChee1(player.clan.khiGas.getMapById(148), level, (int) 1, (int) 2, player);
                            new HaChiJack2(player.clan.khiGas.getMapById(148), level, (int) 1, (int) 2, player);
                            new HaChiJack1(player.clan.khiGas.getMapById(148), level, (int) 1, (int) 2, player);
//                            new TrungUyXanhLo(player.clan.banDoKhoBau.getMapById(137), player.clan.banDoKhoBau.level, (int) dame, (int) hp);
                        ...
                        Service.getInstance().sendThongBao(player, "Vé truy nã khí gas, vui lòng quay lại sau");
                    }
                } else {
