        ...
        for (Zone zone : zones) {
            ...
            switch (this.mapId) {
                ...
                case 91: //7 sao đen
                    ...
                    break;
                case 206: //7 sao đen
                    itemMap = new ItemMap(zone, 1816, 1, 1342, 288, -1);
                    itemMap = new ItemMap(zone, 1817, 1, 1347, 288, -1);
                    itemMap = new ItemMap(zone, 1818, 1, 1353, 288, -1);
                    itemMap = new ItemMap(zone, 1819, 1, 1358, 288, -1);
                    itemMap = new ItemMap(zone, 1820, 1, 1363, 288, -1);
                    itemMap = new ItemMap(zone, 1821, 1, 1368, 288, -1);
                    itemMap = new ItemMap(zone, 1822, 1, 1373, 288, -1);
                    break;    
            }
        }
