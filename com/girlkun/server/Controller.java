...
import static com.girlkun.models.item.ItemTime.DOANH_TRAI;
            ...
            try {
                ...
                switch (cmd) {
                    case 0:
                        ...
                        System.out.println(Logger.YELLOW_BACKGROUND + "version: " + msg.readUTF());
                        break;
                    case 2:
    ...
    public void sendInfo(MySession session) {
        ...
        if (TaskService.gI().getIdTask(player) == ConstTask.TASK_0_0) {
            ...
            NpcService.gI().createTutorial(player, -1,
                    "Chào mừng " + player.name + " đến với Ngọc Rồng Akaya\n"
...
//    }
    ...
    private void sendThongBaoServer(Player player) {
    Service.gI().sendThongBaoFromAdmin(player, "|7| Chào Mừng " + player.name + " Đến Với Server Ngọc rồng Akaya\b|2| Chúc Bạn Chơi Game Vui Vẻ...\nThời gian offline của bạn là " + player.timeoff + " phút");
...
//    ItemTimeService.gI().sendTextTime(player, (byte) DOANH_TRAI, "Nạp tiền tự động ngay trên website: nroobito.com ", 15);
//    ItemTimeService.gI().sendTextTime(player, (byte) CON_DUONG_RAN_DOC, "Mọi thắc mắc liên hệ key vàng để được hỗ trợ ", 20);
           if (Util.canDoWithTime(this.lastTimeGK, 15000)) {
                    ...
                    Service.gI().sendThongBaoAllPlayer("|2|Chào mừng bạn đã đến với NRO AKAYA");
    }
    }
